...
class SingleFileRenderHandler(FileHandler):
    ...
    MARKER_PREFIXES = ("singlefile+https://", "singlefile+http://")
    ...
    def handle_file(
        ...
        real_url = path[len("singlefile+") :]
        with tempfile.TemporaryDirectory() as temp_dir:
            render_page(
                real_url,
                temp_dir,
                crawl_max_depth=crawl_max_depth,
                crawl_inner_links_only=crawl_inner_links_only,
                crawl_rewrite_rule=crawl_rewrite_rule,
